    ...
    return (
        <div className={'body'}>
            <div className={'parallax'}>
                <div className={'txt'}><span className={'imgText'}>About me below</span></div>
            </div>
            ...
            <div className={'parallax-2'}>
                <div className={'txt'}><span className={'imgText'}>Experiences</span></div>
            </div>
            ...
            <div className={'parallax-3'}>
                <div className={'txt'}><span className={'imgText-3'}>What makes me special</span></div>
            </div>
            ...
            <div className={'parallax-4'}>
                <div className={'txt'}><span className={'imgText-4'}>The end(...and the beginning)</span></div>
            </div>
            <div className={'parallax'}>
                <div className={'txt'}><Link className={'link'} to={'/'}>Click to HOME</Link></div>
            </div>
